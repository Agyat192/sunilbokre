    ...
    return (
        <div className="relative perspective-1000 w-full max-w-sm mx-auto md:mr-auto md:ml-0">
            ...
            >
                ...
                <motion.div
                    className="absolute -left-2 bottom-12 px-3 py-1.5 rounded-full bg-background/80 backdrop-blur-md border border-white/10 text-xs font-mono text-foreground shadow-lg"
