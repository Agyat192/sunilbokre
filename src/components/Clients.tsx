...
const Clients = () => {
  ...
  return (
    <section id="clients" className="relative overflow-hidden" ref={containerRef}>
        ...
        <div className="relative -mx-4 sm:-mx-6 lg:-mx-8">
          <motion.div className="flex overflow-hidden" style={{ x: x1 }}>
            <motion.div
              ...
              className="flex gap-8 py-4 px-4 sm:px-6 lg:px-8"
            >
              {[...clients, ...clients].map((client, index) => (
                <motion.div
                  ...
                  className="group flex-shrink-0 w-48 sm:w-64 rounded-2xl bg-background/50 backdrop-blur-sm border border-border/20 transition-all duration-300 cursor-pointer overflow-hidden"
                  data-magnetic
